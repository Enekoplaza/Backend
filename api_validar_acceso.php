...
if ($res_user->num_rows === 0) {
    echo json_encode(['estado' => 'error', 'mensaje' => 'DNI no encontrado']);
    exit;
}
...
if ($stmt_insert->execute()) {
    // Calculamos los RESTANTES (Aforo Max - (Asistentes antes + el de ahora))
